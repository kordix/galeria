  ...
  <script>
    ...
    let app = new Vue({
      ...
      methods: {
        ...
        usun(argument){
          fetch('/api/delete.php?folder=' + this.folder + '&image='+argument ).then((res) => {location.reload()});
        },
        rename(file){
          fetch('/api/delete.php?folder=' + this.folder + '&image='+argument ).then((res) => {location.reload()});
        },
        ...
        postRename(){
          fetch('/api/rename.php?folder=' + this.folder + '&nazwa='+this.oldfilename+'&nazwa2='+this.newfilename ).then((res) => {location.reload()});
        },
        resize(file){
          console.log(file);
